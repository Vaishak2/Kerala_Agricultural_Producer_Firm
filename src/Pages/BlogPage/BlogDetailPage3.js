...
import BlogsBanner3 from "../../Assets/Banner-Image/blogsBanner3.png"
import blogsBanner3Resp from "../../Assets/Banner-Image/blogsBanner3-resp.png"
...
function BlogDetailPage3() {
    ...
    return (
        <div className='sm:mx-8 mx-4 mt-[40px]'>
            <img className='sm:block hidden' src={BlogsBanner3}></img>
            <img className='sm:hidden block' src={blogsBanner3Resp}></img>
