...
function AboutBanner() {
    return (
        <div className="mx-[16px]">
            ...
            <div className="bg-about-mobile sm:bg-about-banner bg-cover w-[395px] h-[352px] sm:w-[1376px] sm:h-[433px] mx-[] sm:mt-[40px] mt-[32px]">
            ...
            <div className="mt-[32px] sm:mt-[40px] text-[16px] sm:text-[16px] font-light text-justify  sm:px-[32px] w-[396px] sm:w-[1368px] text-[#2A2E35]">
            ...
            <div className="mt-[24px] sm:mt-[24px] text-justify w-[362px] sm:ml-[32px] leading-[24px] sm:leading-[28px] font-normal text-[16px] sm:text-[16px] text-[#2A2E35]">
