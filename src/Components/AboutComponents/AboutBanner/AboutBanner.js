...
function AboutBanner() {
    return (
        <div className="sm:px-8 px-4">
            ...
            <div className="bg-about-mobile sm:bg-about-banner rounded-3xl bg-cover w-full h-[352px] sm:w-full sm:h-[433px] mx-[] sm:mt-[40px] mt-[32px]">
            ...
            <div className="mt-[24px] sm:mt-[24px] text-justify w-full  leading-[24px] sm:leading-[28px] font-normal text-[16px] sm:text-[16px] text-[#2A2E35]">
