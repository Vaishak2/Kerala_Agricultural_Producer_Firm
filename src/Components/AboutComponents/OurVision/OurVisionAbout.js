...
function OurVisionAbout() {
  return (
    ...
    <div className='bg-[#5D8424] sm:rounded-[64px] rounded-[32px] w-full h-auto mt-[72px] p-[32px]  sm:w-full sm:h-[563px] sm:mt-[104px] sm:p-[60px]'>
      <div className='flex'>
      ...
      <div className='flex sm:mt-[24px] mt-[16px] ml-[50px] sm:ml-[64px] text-white font-light text-[18px] sm:text-[28px] leading-[32px] sm:tracking-normal tracking-tight sm:leading-[44px] text-start w-full sm:w-[1115px]'>
