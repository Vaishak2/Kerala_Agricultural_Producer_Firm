...
function SupportsGrid() {
    return (
        <div className='bg-[#FFFFFF] sm:mx-auto sm:h-[375px] w-[396px] sm:w-[1376px] mx-auto sm:mt-[40px] mt-8  rounded-2xl'>
            <div className='sm:w-[1304px] w-[396px]   sm:mx-[36px] sm:flex sm:grid-cols-4 py-[55px]'>
