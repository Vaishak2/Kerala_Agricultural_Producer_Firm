...
function Marquee() {
    ...
    return (
        <div className="overflow-hidden sm:mt-[104px]">
            <div
                className="marquee-content sm:text-[88px] sm:leading-[82px] flex sm:font-medium whitespace-nowrap gap-9 sm:h-[97px] items-center"
                ref={marqueeRef}
            >
                <h1 className="text-[#009EE3]">Support</h1>
                <img className="sm:w-4 sm:h-4" src={GrayDot} alt="" />
